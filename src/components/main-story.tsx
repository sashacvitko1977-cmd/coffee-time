  ...
  return (
    <div className="relative h-[100svh] w-full overflow-hidden">
      ...
      {stage === 1 && (
        ...
        >
          {/* Thin line from card toward the cup */}
          <div
            className="absolute top-1/2 h-px origin-left bg-amber shadow-[0_0_6px_rgba(232,149,74,0.5)]"
            aria-hidden="true"
            style={{
          ...
          {/* Info — left, fades in near end of first segment */}
          <div
            className="pointer-events-auto absolute left-0 top-1/2 w-full max-w-[min(100%,22rem)] -translate-y-1/2 px-4 sm:left-6 sm:px-0 md:left-10 lg:left-14"
            style={{
              opacity: coffeeOpacity,
